<%@ Page Language="C#" AutoEventWireup="true" CodeFile="student-insert.aspx.cs" Inherits="features_student_details" %>
    ...
    <form id="form1" runat="server">
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="nameBox" ErrorMessage="Student name is must" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Providing email is must" ControlToValidate="emailBox" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td class="auto-style3">
                    <asp:TextBox ID="dobBox" runat="server"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="auto-style3">
                    <asp:DropDownList ID="countryDropdown" runat="server" OnSelectedIndexChanged="countryDropdown_SelectedIndexChanged" Width="181px">
