<%@ Page Language="C#" AutoEventWireup="true" CodeFile="enroll-insert.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="features_course_course_insert" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     <div style="display: flex; align-items: center; color: #A62A22">
     <i class="fa fa-arrow-left"></i>
     <a style="margin-left: 3px" href="enroll-inspect.aspx">Go Back</a>
 </div>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="form-group">
                ...
                <asp:TextBox ID="enrollDateBox" runat="server" CssClass="form-control item" Placeholder="Lesson Title" type="date"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="enrollDateBox" ErrorMessage="Enrolled date is required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
            </div>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="head">
    <script>
        ...
        function myFunction() {
            ...
            var name = document.getElementById('<%= enrollDateBox.ClientID %>').value;
            console.log(name)
            if (name.trim() !== '' ) {
